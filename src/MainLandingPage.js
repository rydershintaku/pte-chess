...
export default ({
  ...
  heading = "The All Modern Revolutionizing way to play Chess",
  description = "P-2-E Chess is an innovative online chess platform that seamlessly blends the timeless game of chess with the cutting-edge world of blockchain technology. Whether you’re a seasoned grandmaster or a curious beginner, P-2-E Chess offers an exhilarating experience that transcends traditional chess play."
}) => {
  /*
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <HeroRow>
            <UpdateNotice>
              <UpdateNoticeIcon />
              Last updated on 5th May, 2024 - Added support for NFT and Profile!
            </UpdateNotice>
            <TextColumn>
            ...
            <ImageColumn>
              <ImageContainer style={{ marginLeft: '200px' }}>
                <Image src={neonChess} />
              </ImageContainer>
            </ImageColumn>
          </HeroRow>
